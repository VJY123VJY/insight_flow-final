...
class Settings(BaseSettings):
    ...
    MDU_API_KEY: Optional[str] = Field(default=None, description="Optional API key for authenticating with the MDU")
    ...
    BUCKET_ENDPOINT: str = Field(default="http://localhost:9000/audit", description="Bucket audit API")
    BUCKET_AUTH_TOKEN: Optional[str] = None
    BUCKET_TIMEOUT: int = Field(default=3, description="HTTP timeout seconds for Bucket requests")
